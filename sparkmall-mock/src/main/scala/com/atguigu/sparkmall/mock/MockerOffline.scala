...
import com.atguigu.bigdata.sparkmall.common.bean.DataModule.{CityInfo, ProductInfo, UserInfo, UserVisitAction}
...
object MockerOffline {
  ...
  def mockUserAction()={
    ...
    val endDate = new   SimpleDateFormat("yyyy-MM-dd").parse("2018-12-31")
