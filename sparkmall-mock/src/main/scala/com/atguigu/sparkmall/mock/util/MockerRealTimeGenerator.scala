...
import com.atguigu.bigdata.sparkmall.common.bean.DataModule.CityInfo
import com.atguigu.bigdata.sparkmall.common.util.SparkmallUtil
import org.apache.kafka.clients.producer.{KafkaProducer, ProducerConfig, ProducerRecord}

import scala.collection.mutable.ArrayBuffer

object MockerRealTimeGenerator {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val broker = SparkmallUtil.getValFromConfig("kafka.broker.list")
